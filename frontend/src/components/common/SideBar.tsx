...
export const SideBar = (props: {}) => {
  ...
  return (
    <Box className={`flex flex-col px-2 pt-2 h-screen bg-white  border-r-2 border-r-blue-500 transition-all duration-300 ${sideOpen ? 'w-72' : 'w-14 items-center'}`}>
      ...
      {/* Footer / User */}
      <div className={`mt-auto -mx-2 ${sideOpen ? 'border-t-2 border-t-black w-[calc(100%+1rem)]' : ''}  flex items-center gap-3 py-2 px-3 hover:cursor-pointer text-gray-600 hover:text-blue-500 hover:bg-blue-50 active:bg-blue-100 active:scale-95 transition-all duration-150 ${!sideOpen && 'justify-center'}`}>
